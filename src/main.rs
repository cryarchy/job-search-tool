...
async fn main() -> io::Result<()> {
    ...
    let mut directory_src_options = DirectorySourceOptions::default();
    directory_src_options.tpl_extension = ".hbs".to_owned();
    directory_src_options.hidden = false;
    directory_src_options.temporary = false;
    let mut handlebars = Handlebars::new();
    handlebars
        .register_templates_directory("./templates", directory_src_options)
        .unwrap();
